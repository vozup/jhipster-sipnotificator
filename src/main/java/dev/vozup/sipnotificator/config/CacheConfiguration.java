package dev.vozup.sipnotificator.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, dev.vozup.sipnotificator.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, dev.vozup.sipnotificator.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, dev.vozup.sipnotificator.domain.Notification.class.getName() + ".names");
