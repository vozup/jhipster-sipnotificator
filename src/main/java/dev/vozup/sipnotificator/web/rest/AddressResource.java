...
import dev.vozup.sipnotificator.domain.Address;
import dev.vozup.sipnotificator.repository.AddressRepository;
...
/**
 * REST controller for managing {@link dev.vozup.sipnotificator.domain.Address}.
 */
@RestController
@RequestMapping("/api")
@Transactional
