...
import dev.vozup.sipnotificator.domain.Notification;
import dev.vozup.sipnotificator.repository.NotificationRepository;
...
/**
 * REST controller for managing {@link dev.vozup.sipnotificator.domain.Notification}.
 */
@RestController
@RequestMapping("/api")
@Transactional
